  ...
  `,t.appendChild(m);const l=document.createElement("div");l.className="semantic-network",[{class:"node center",label:e("targetWord"),hint:""},{class:"node top",label:e("hypernymWord"),hint:e("hypernym")},{class:"node bottom",label:e("hyponymWord"),hint:e("hyponym")},{class:"node left",label:e("synonymWord"),hint:e("synonym")},{class:"node right",label:e("antonymWord"),hint:e("antonym")}].forEach(v=>{const E=document.createElement("div");E.className=v.class;const k=document.createElement("div");if(k.className="word",k.textContent=v.label,E.appendChild(k),v.hint){const _=document.createElement("div");_.className="hint",_.textContent=v.hint,E.appendChild(_)}l.appendChild(E)}),l.insertAdjacentHTML("afterbegin",`
    ...
    `,_.onclick=()=>I(),p.appendChild(h),p.appendChild(v),p.appendChild(E),p.appendChild(k),p.appendChild(_),l.appendChild(p),m.appendChild(l);const b=document.createElement("div");b.className="grid",d.appendChild(b),m.appendChild(d);function x(A){c=2,l.style.display="none",d.style.display="block",o.style.display="none",b.innerHTML="",(A==="pronomen"?[{key:"pronominerSubjekt",type:"subjekt",icon:"🔦",img:"pronominer_spotlight.png"},{key:"pronominerObjekt",type:"objekt",icon:"👤",img:"pronominer_objekt.png"},{key:"pronominerPossessiv",type:"possessiv",icon:"🏠",img:"pronominer_possessiv.png"},{key:"pronominerRefleksiv",type:"refleksiv",icon:"🔄",img:"pronominer_refleksiv.png"}]:[{key:"verbumLearning",type:"verber_nutid",icon:"🏃",img:"verber_kategorier.png"},{key:"verberDatidRegelm",type:"datid_regelm",icon:"🕰️",img:"verber_kategorier.png"},{key:"verberDatid",type:"datid",icon:"🕰️",img:"verber_kategorier.png"},{key:"verberTider",type:"tider",icon:"🌉",img:"verber_kategorier.png"}]).forEach(S=>{const w=document.createElement("div");w.className="card",w.onclick=()=>{S.type==="verber_nutid"?i("verbum_menu"):S.key.startsWith("verber")?i("verbum_learning",{categoryId:S.type,backView:"pronomen"}):(S.type,f(S.type,S.img))};const D=document.createElement("div");D.className="card-icon",D.textContent=S.icon;const T=document.createElement("div");T.className="card-title",T.textContent=e(S.key),w.appendChild(D),w.appendChild(T),b.appendChild(w)})}function f(A,L){c=3,d.style.display="none",o.style.display="block",y.innerHTML="",g.textContent=e("hanHamHans"),[...Be[A]].forEach((w,D)=>{const T=document.createElement("div");T.className="card",T.onclick=()=>{s=[...w.exercises].sort(()=>Math.random()-.5),N({key:"pronominer"+A.charAt(0).toUpperCase()+A.slice(1),type:A,img:L})};const H=document.createElement("div");H.className="card-icon",H.textContent="📝";const z=document.createElement("div");z.className="card-title",z.textContent=`Sæt ${D+1}`,T.appendChild(H),T.appendChild(z),y.appendChild(T)})}const y=document.createElement("div");y.className="grid",o.appendChild(y),m.appendChild(o),r.onclick=()=>{a.style.display==="block"?(a.style.display="none",m.style.display="block",c===3?(o.style.display="block",d.style.display="none"):(d.style.display="block",o.style.display="none"),g.textContent=e("hvilketOrd")):o.style.display==="block"?(o.style.display="none",d.style.display="block",c=2,g.textContent=e("hvilketOrd")):d.style.display==="block"?(d.style.display="none",l.style.display="block",c=1,g.textContent=e("hvilketOrd")):i("dagens_opgave")};function C(){m.style.display="none",a.style.display="block",a.innerHTML="",g.textContent=e("derErDetEr");const A=document.createElement("div");A.className="der-er-explanation";const L=document.createElement("div");L.className="expl-slide",L.innerHTML=`
        ...
        `,L.querySelector(".next-slide-btn").onclick=()=>{L.style.display="none",S.style.display="block"},S.querySelector(".start-practice-btn").onclick=()=>{j()},A.appendChild(L),A.appendChild(S),a.appendChild(A)}function j(){a.innerHTML="";const A=[{text:"Se! [blank_0] en hund i haven.",answer:"Der er",options:["Der er","Det er"]},{text:"[blank_0] en stor hund. Se den!",answer:"Det er",options:["Der er","Det er"]},{text:"Hvem banker på døren? [blank_0] nok min mor.",answer:"Det er",options:["Der er","Det er"]},{text:"[blank_0] mange mennesker i toget i dag.",answer:"Der er",options:["Der er","Det er"]},{text:"[blank_0] en dejlig kop kaffe, du har her.",answer:"Det er",options:["Der er","Det er"]}];let L=0;function S(){a.innerHTML="";const D=A[L],T=document.createElement("div");T.className="pronomen-exercise-content";const H=document.createElement("div");H.className="exercise-progress",H.textContent=`Opgave ${L+1} af ${A.length}`,T.appendChild(H);const z=document.createElement("div");z.className="grammatik-text-container",D.text.split(/(\[blank_0\])/).forEach(W=>{if(W==="[blank_0]"){const V=document.createElement("select");V.className="grammatik-select";const $=document.createElement("option");$.value="",$.textContent="...",V.appendChild($),D.options.forEach(Z=>{const U=document.createElement("option");U.value=Z,U.textContent=Z,V.appendChild(U)});const q=document.createElement("div");q.className="exercise-feedback";const G=document.createElement("span");G.className="select-wrapper",G.appendChild(V),z.appendChild(G),V.onchange=()=>{V.value===D.answer?(V.classList.add("correct"),V.classList.remove("wrong"),q.style.display="none",F.disabled=!1):V.value!==""?(V.classList.add("wrong"),V.classList.remove("correct"),q.textContent=e("hintDerDet"),q.style.display="block",F.disabled=!0):(V.classList.remove("correct","wrong"),q.style.display="none",F.disabled=!0)},T.appendChild(q)}else{const V=document.createElement("span");V.textContent=W,z.appendChild(V)}}),T.appendChild(z);const F=document.createElement("button");F.className="gemini-btn",F.textContent="Check",F.disabled=!0,F.onclick=()=>{L++,L<A.length?S():w()},T.appendChild(F),a.appendChild(T)}function w(){a.innerHTML=`
            ...
            `}S()}function I(){m.style.display="none",a.style.display="block",a.innerHTML="",g.textContent=e("adverbChoice"),Pe(a)}function N(A){m.style.display="none",a.style.display="block",a.innerHTML="",g.textContent=e(A.key);const L=document.createElement("img");L.src=J+A.img,L.className="pronomen-illustration",a.appendChild(L);const S=document.createElement("div");S.className="pronomen-exercise-content";const w=document.createElement("div");w.className="pronomen-list";const D=s.length;let T=0;s.forEach((W,V)=>{const $=document.createElement("div");$.className="pronomen-row";const q=document.createElement("div");q.className="person-badge",q.textContent=W.person||"",$.appendChild(q);const G=document.createElement("div");G.className="grammatik-text-container",W.text.split(/(\[blank_\d+\])/).forEach(U=>{const ne=U.match(/\[blank_(\d+)\]/);if(ne){const Y=ne[1],X=document.createElement("span");X.className="select-wrapper";const M=document.createElement("select");M.className="grammatik-select",M.dataset.exIdx=V,M.dataset.blankIdx=Y;const ee=document.createElement("option");ee.value="",ee.textContent="...",M.appendChild(ee),[...W.blanks[Y].options].sort(()=>Math.random()-.5).forEach(Q=>{const O=document.createElement("option");O.value=Q,O.textContent=Q,M.appendChild(O)});const R=document.createElement("div");R.className="exercise-feedback-row",R.style.display="none",M.onchange=()=>{const Q=M.value;if(Q===W.blanks[Y].answer)M.classList.add("correct"),M.classList.remove("wrong"),R.style.display="none",M.dataset.solved||(M.dataset.solved="true",T++,F());else if(Q!==""){M.classList.add("wrong"),M.classList.remove("correct");let O="hintPronominer";A.type==="subjekt"?O="hintPronominerSubjekt":A.type==="objekt"?O="hintPronominerObjekt":A.type==="possessiv"?O="hintPronominerPossessiv":A.type==="refleksiv"&&(O="hintPronominerRefleksiv");const ie=W.person?` (${W.person})`:"";R.textContent=e(O)+ie,R.style.display="block",M.dataset.solved&&(delete M.dataset.solved,T--,F())}else M.classList.remove("correct","wrong"),R.style.display="none",M.dataset.solved&&(delete M.dataset.solved,T--,F())},X.appendChild(M),G.appendChild(X),$.appendChild(G),$.appendChild(R)}else{const Y=document.createElement("span");Y.textContent=U,G.appendChild(Y)}}),w.appendChild($)}),S.appendChild(w);const H=document.createElement("div");H.className="grammatik-summary",H.style.display="block",S.appendChild(H);const z=document.createElement("div");z.className="game-controls";const K=document.createElement("button");K.className="gemini-btn",K.textContent="Færdig! 🎉",K.style.display="none",K.onclick=()=>{location.reload()};function F(){H.textContent=`${T} / ${D} ${e("correct")}`,T===D?K.style.display="inline-block":K.style.display="none"}F(),z.appendChild(K),S.appendChild(z),a.appendChild(S)}if(t.appendChild(m),t.appendChild(a),u.appendChild(t),!document.getElementById("pronomen-styles")){const A=document.createElement("style");A.id="pronomen-styles",A.textContent=`
