...
export function renderAiConversationArbejdeView(container, navigateFn, extraData = {}) {
    ...
    function handleUserInput(text) {
        ...
        switch (currentNode) {
            case 0: // Intro, asked when to meet
                currentNode = 1;
                annaReplies("Okay. Hvor mange timer arbejder du om ugen?");
                break;
            case 1: // Hours
                currentNode = 2;
                annaReplies("Det lyder spændende. Hvad laver du på dit arbejde?");
                break;
            case 2: // What do you do
                currentNode = 3;
                annaReplies("Ah, okay. Hvor mange kolleger har du?");
                break;
            case 3: // How many colleagues
                currentNode = 4;
                annaReplies("Det er dejligt. Hvor kommer dine kolleger fra?");
                break;
            case 4: // Where from
                currentNode = 5;
                annaReplies("Spændende. Hvad laver du i dine pauser?");
                break;
            case 5: // Pauses
                currentNode = 6;
                annaReplies("Det lyder hyggeligt. Hvor mange pauser har du om dagen?");
                break;
            case 6: // How many pauses
                currentNode = 7;
                annaReplies("Okay. Hvordan kommer du på arbejde?");
                break;
            case 7: // Transport
                currentNode = 8;
                annaReplies("Fint. Kan du lide dit arbejde?");
                break;
            case 8: // Like it?
                currentNode = 9;
                annaReplies("Hvorfor kan du lide eller ikke lide det?");
                break;
            case 9: // Why
                currentNode = 10;
    ...
    // Start Conversation
    setTimeout(() => {
        annaReplies("Hej! Jeg hedder Anna. Jeg vil gerne høre lidt om dit arbejde. Hvornår møder du på arbejde?");
    }, 500);
