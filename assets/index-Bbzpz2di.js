  ...
  `,t.appendChild(o);const s=document.createElement("div");s.className="semantic-network",[{class:"node center",label:e("targetWord"),hint:""},{class:"node top",label:e("hypernymWord"),hint:e("hypernym")},{class:"node bottom",label:e("hyponymWord"),hint:e("hyponym")},{class:"node left",label:e("synonymWord"),hint:e("synonym")},{class:"node right",label:e("antonymWord"),hint:e("antonym")}].forEach(k=>{const D=document.createElement("div");D.className=k.class;const v=document.createElement("div");if(v.className="word",v.textContent=k.label,D.appendChild(v),k.hint){const _=document.createElement("div");_.className="hint",_.textContent=k.hint,D.appendChild(_)}s.appendChild(D)}),s.insertAdjacentHTML("afterbegin",`
    ...
    `,t.appendChild(s);const c=document.createElement("div");c.className="exercise-container",t.appendChild(c);let i={step:1,nounAnchor:"",verbAnchor:"",sentenceParts:[]};function l(){c.innerHTML="",i.step===1?m():i.step===2?d():i.step===3&&p()}function m(){const _=document.createElement("div");_.className="step-content",_.innerHTML=`
        ...
        `,c.appendChild(_);const h=_.querySelector("#verb-select");h.onchange=()=>{h.value&&(i.verbAnchor=h.value,i.step=3,setTimeout(l,1e3))}}function p(){const _=document.createElement("div");_.className="step-content",_.innerHTML=`
            ...
            <div class="exercise-feedback" id="step-feedback"></div>
        `,c.appendChild(_);const h=_.querySelectorAll(".drag-item"),f=_.querySelector("#ground"),y=_.querySelector("#source");h.forEach(w=>{w.ondragstart=S=>{S.dataTransfer.setData("text/plain",w.dataset.word),w.classList.add("dragging")},w.ondragend=()=>w.classList.remove("dragging")});let C=null,x=0,j=0,P=null;h.forEach(w=>{w.ontouchstart=S=>{C=w,P=w.parentElement;const A=S.touches[0],H=w.getBoundingClientRect();_.getBoundingClientRect(),x=A.clientX-H.left,j=A.clientY-H.top,w.classList.add("dragging"),w.style.position="absolute",w.style.zIndex="2000",w.style.width=H.width+"px",w.style.pointerEvents="none",w.style.transition="none",_.style.position="relative",_.appendChild(w),E(A.clientX,A.clientY),S.preventDefault()},w.ontouchmove=S=>{if(!C)return;const A=S.touches[0];E(A.clientX,A.clientY),S.preventDefault()},w.ontouchend=S=>{if(!C)return;const A=S.changedTouches[0];w.classList.remove("dragging"),w.style.position="",w.style.zIndex="",w.style.width="",w.style.top="",w.style.left="",w.style.pointerEvents="",w.style.transition="";const H=document.elementFromPoint(A.clientX,A.clientY),z=H?.closest(".drop-zone")||H?.closest(".drag-source");if(z)if(z.id==="ground"){const K=T(f,A.clientX);K==null?f.appendChild(w):f.insertBefore(w,K)}else y.appendChild(w);else P.appendChild(w);C=null,S.preventDefault()}});function E(w,S){if(C){const A=_.getBoundingClientRect();C.style.left=w-A.left-x+"px",C.style.top=S-A.top-j+"px"}}f.ondragover=w=>w.preventDefault(),f.ondrop=w=>{w.preventDefault();const S=w.dataTransfer.getData("text/plain"),A=y.querySelector(`.drag-item[data-word="${S}"]`)||f.querySelector(`.drag-item[data-word="${S}"]`);if(A){const H=T(f,w.clientX);H==null?f.appendChild(A):f.insertBefore(A,H)}};function T(w,S){return[...w.querySelectorAll(".drag-item:not(.dragging)")].reduce((H,z)=>{const K=z.getBoundingClientRect(),F=S-K.left-K.width/2;return F<0&&F>H.offset?{offset:F,element:z}:H},{offset:Number.NEGATIVE_INFINITY}).element}y.ondragover=w=>w.preventDefault(),y.ondrop=w=>{w.preventDefault();const S=document.querySelector(".drag-item.dragging");S&&y.appendChild(S)};const N=_.querySelector("#check-btn"),L=_.querySelector("#step-feedback");N.onclick=()=>{const w=Array.from(f.children).map(A=>A.dataset.word).join(" "),S=`${i.nounAnchor} barn ${i.verbAnchor}`.toLowerCase();w.toLowerCase()===S?(L.textContent=e("groundingSuccess"),L.className="exercise-feedback success-text",L.style.display="block",N.disabled=!0,b(_,()=>{k(_),setTimeout(()=>{D(_)},5500)})):(L.textContent=e("wrongOrder"),L.className="exercise-feedback",L.style.display="block")}}function b(_,h){let f=_.querySelector(".focus-container");f||(f=document.createElement("div"),f.className="focus-container animate-in",_.appendChild(f));const y=i.nounAnchor;let C="",x="";y==="Mit"?(x=e("groundingRelation"),C=`
...
`,this.attachEventListeners(a),this.ensureStyles(),a}getSummaryText(a){const r=(this.currentPhase===1?a.segments.filter(g=>g.type==="gap"):a.phase2_tasks).length,n=Object.values(this.feedback).filter(g=>g==="correct").length;return n===0?"":n===r?`<span class="success">${e("allCorrect")}</span>`:e("filledProgress",{n,total:r})}renderPhase1(a){const t=[];let r=null;return a.segments.forEach(n=>{n.type==="text"?n.content.split(/(\d+\.\s+)/).forEach(o=>{o.match(/^\d+\.\s+$/)&&(r&&t.push(r),r={segments:[]}),r&&r.segments.push({type:"text",content:o})}):r&&r.segments.push(n)}),r&&t.push(r),t.map((n,g)=>{let o=null,s=null;const c=n.segments.map(m=>{if(m.type==="text"){const d=m.content.match(/\*\*\[(.*?)\]\*\*/);d&&(o=d[1],s="verbClue_"+this.normalize(o));let p=m.content.replace(d?d[0]:"","").replace(/\\n/g," ").replace(/\d+\.\s+/g,"").replace(/Dansk:\s*/gi,"").replace(/\s+/g," ").trim();const b=m.content.match(/Dansk:/i)?`<span class="sentence-label">${e("danishLabel")}:</span> `:"";return p?`${b}<span class="text-part">${p}</span>`:""}else{const d=this.feedback[m.id]==="correct",p=this.feedback[m.id]==="wrong";return`
        ...
        `,document.head.appendChild(d)}u.appendChild(r)}function Ve(u,a,t={}){const r=t.nounAnchor||B.nounAnchor||"Et",n=t.selectedNoun||B.selectedNoun||"barn",g=t.selectedVerb||B.selectedVerb||"spiser";let o="langsomt";u.innerHTML=`
    ...
    `;const b=v=>v==="Et"?"stort":v==="Det"||v==="Mit"?"store":"stort";p.textContent=b(r);function k(v){let _="1.5s",h=3,f="#ffeb3b",y=2;v==="hurtigt"?(_="0.4s",f="#4caf50",h=5):v==="langsomt"?(_="3.5s",f="#2196f3",h=2):v==="meget"?(_="1s",f="#f44336",h=8,y=4):v==="lidt"&&(_="2s",f="#9e9e9e",h=1,y=1);let C="";for(let j=0;j<h;j++){const E=30+(j-(h-1)/2)*10;C+=`
        ...
        `,document.head.appendChild(v)}}function Ke(u,a,t={}){const r=t.nounAnchor||B.nounAnchor||"Et",n=t.selectedNoun||B.selectedNoun||"barn",g=t.selectedVerb||B.selectedVerb||"spiser",o=t.selectedAdverb||B.selectedAdverb||"langsomt",s=t.adjectivePart||"stort";let c="fordi";u.innerHTML=`
        <div class="grounding-container animate-in">
            <div class="header-section">
