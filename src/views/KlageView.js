...
export function renderKlageView(container, navigateFn) {
    ...
    title.textContent = getTranslation('enKlage');

    // Padlet Card
    const card = document.createElement('div');
    card.className = 'card';
    card.style.cursor = 'pointer';
    card.onclick = () => window.open('https://padlet.com/mibf/en-klage-fv80qrahnyjw5e45', '_blank');
